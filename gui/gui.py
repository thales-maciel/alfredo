...
class RootLayout(GridLayout):
    def __init__(self, alfredo, **kwargs):
        super().__init__(**kwargs)
        self.cols = 1
        self.rows = 2

        self.alfredo = alfredo

        # Text Input
        self.textinput = TextInput(text='', multiline=False, size_hint_y=None, height=50)
    ...
    def on_text(self, instance, value):
        self.alfredo.parse_input(value)
...
class MainApp(MDApp):
    def __init__(self, **kwargs):
        ...
        self.alfredo = Alfredo(self)
        self.screen = RootLayout(self.alfredo)
